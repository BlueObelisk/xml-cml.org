...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-GB" lang="en-GB">
    ...
    <link href="/css/XMLDisplay.css" type="text/css" rel="stylesheet" media="screen" />
	...
	<script type="text/javascript" src="/js/superfish.js"></script>
		...
		<title>Chemical Markup Language | CML Dictionary</title>
	</head>
	<body>
		<div class="page clear" id="wrapper">
			...
			<div id="content">
				<p>This is the CML dictionary and contains some simple and general concepts which are useful across many disciplines.</p>
				<div id="XMLHolder">
					<script> LoadXML('XMLHolder', 'dictionary.cml'); </script>
				</div>
			</div>
