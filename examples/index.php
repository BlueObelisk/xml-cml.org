...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-GB" lang="en-GB">
	<head profile="http://dublincore.org/documents/dcq-html/">
		...
		<title>Chemical Markup Language | Examples</title>
	</head>
	<body>
		<div id="wrapper" class="page clear">
			...
			<div id="content">
				<p>Please click on the links below to find examples for that schema.</p>
				<ul>
					<li><a href="/examples/schema3/index.php">Schema 3 examples</a></li>
					<li><a href="/examples/schema24/index.php">Schema 2.4 examples</a></li>
				</ul>
			</div>
