			...
			<div id="header">
				...
				<div id="breadcrumbs" class="clear">
					<ul>
						...
						<li><a href="/examples/schema3/index.php">Schema 3</a></li>
						<li><a href="/examples/schema3/molecular/index.php">Molecular</a></li>
						<li>scalar-must-have-units-and-datatype-and-be-child-of-property</li>
					</ul>
				</div>
			</div>
			<div id="content">
				<div id="XMLHolder">
					<script> LoadXML('XMLHolder', 'scalar-must-have-units-and-datatype-and-be-child-of-property.cml'); </script>
				</div>
			</div>
