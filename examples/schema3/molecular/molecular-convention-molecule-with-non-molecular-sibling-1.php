			...
			<div id="header">
				...
				<div id="breadcrumbs" class="clear">
					<ul>
						...
						<li>molecular-convention-molecule-with-non-molecular-sibling-1</li>
					</ul>
				</div>
			</div>
			<div id="content">
				<div id="XMLHolder">
					<script> LoadXML('XMLHolder', 'molecular-convention-molecule-with-non-molecular-sibling-1.cml'); </script>
				</div>
			</div>
