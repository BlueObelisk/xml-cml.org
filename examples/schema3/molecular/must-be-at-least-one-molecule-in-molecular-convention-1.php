			...
			<div id="header">
				...
				<div id="breadcrumbs" class="clear">
					<ul>
						...
						<li>must-be-at-least-one-molecule-in-molecular-convention-1</li>
					</ul>
				</div>
			</div>
			<div id="content">
				<div id="XMLHolder">
					<script> LoadXML('XMLHolder', 'must-be-at-least-one-molecule-in-molecular-convention-1.cml'); </script>
				</div>
			</div>
